...
board = "C_Chat/"
board2 = "Stock/"
for i in range(17500,17526): 

# TODO: change this code
    URL = "https://www.ptt.cc/bbs/C_Chat/index%d.html" % i
    print("URL", URL)
...
for i in range(4980,4994): 

# TODO: change this code
    URL = "https://www.ptt.cc/bbs/Stock/index%d.html" % i
    print("URL", URL)
    ...
    for article in articles[:3]:    
        ...
        directory = article["date"]
        path = board2 + directory[:10]
        if directory[:10] not in os.listdir(board2):
            os.mkdir(path = path)
